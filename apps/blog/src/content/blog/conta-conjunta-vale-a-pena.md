...
Se a renda de vocês é muito diferente, a divisão meio a meio pode pesar injustamente para quem ganha menos — nesse caso vale conhecer a [divisão proporcional ao salário](/blog/dividir-contas-proporcional-ao-salario) antes de definir o aporte de cada um.
...
| Modelo | Como funciona | Para quem funciona | Principal risco |
|---|---|---|---|
| **Conjunta total** | Toda a renda dos dois cai numa conta só; tudo sai dela | Casais com finanças totalmente integradas e estilos parecidos | Perda de autonomia; separação e dívidas atingem tudo |
| **Contas separadas** | Cada um mantém sua conta e paga sua parte das despesas combinadas | Início de relação; quem valoriza independência | Logística de acertos mensais; pouca visibilidade do todo |
| **Híbrido** | Cada um mantém sua conta + uma conta comum só para as despesas da casa | A maioria dos casais que moram juntos | Exige definir regras de aporte e do que "entra" na conta |
